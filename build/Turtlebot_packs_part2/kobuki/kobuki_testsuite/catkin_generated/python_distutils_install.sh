...
echo_and_run cd "/home/jan/ROS/src/Turtlebot_packs_part2/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jan/ROS/src/Turtlebot_packs_part2/kobuki/kobuki_testsuite/setup.py" \
     \
    build --build-base "/home/jan/ROS/build/Turtlebot_packs_part2/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
